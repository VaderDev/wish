...
local cto_struct = function (name, id, description)
	...
	table.insert(description, member_sc("int", "id", id))
...
cto_struct("CTO_FleetSpawn", 30, {
	member_v("int", "factionID", "-1"),
	member_v("int", "fleetID", "-1"),
	member_v("int", "position"),
})
...
cto_struct("CTO_FleetSelectBox", 34, {
	member_mv("std::vector<int>", "fleetIDs"),
})

cto_struct("CTO_FleetMove", 35, {
	member_v("int", "target_position"),
})
