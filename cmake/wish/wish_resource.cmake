...
function(wish_resource_mapping)
	...
	foreach (resource IN LISTS arg_RESOURCE_root)
		...
		string(REPLACE @ "" resource "${resource}")
		file(GLOB_RECURSE matching_physical LIST_DIRECTORIES false RELATIVE "${arg_RELATIVE}" CONFIGURE_DEPENDS "${PROJECT_SOURCE_DIR}/${resource}")
		file(GLOB_RECURSE matching_virtual LIST_DIRECTORIES false RELATIVE "${PROJECT_SOURCE_DIR}" CONFIGURE_DEPENDS "${PROJECT_SOURCE_DIR}/${resource}")
